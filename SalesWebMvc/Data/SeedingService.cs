...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void See() 
        {
            ...
            Seller s2 = new Seller(2, "Jose Pereira", "jos@gmail.com", new DateTime(1999, 12, 14), 2000.0, d2);
            Seller s3 = new Seller(3, "Pedro Alcantra", "ped@gmail.com", new DateTime(1993, 4, 4), 1500.0, d1);
            Seller s4 = new Seller(4, "Ana Selis", "ana@gmail.com", new DateTime(1980, 7, 17), 3500.0, d4);
            Seller s5 = new Seller(5, "Maria Rocha", "mar@gmail.com", new DateTime(2002, 12, 14), 1850.0, d3);
            Seller s6 = new Seller(6, "Rose Meire", "ros@gmail.com", new DateTime(2004, 11, 24), 1900.0, d2);
